<?php
/*
    Template Name: Docentes y Horarios
...
if( have_rows('contenido') ):
    ...
    while ( have_rows('contenido') ) : the_row(); 
        ...
        if( get_row_layout() == 'carreras_y_planes' ): 
				...
				if( have_rows('formulario') ): ?>
					...
					while( have_rows('formulario') ): the_row();
                        ...
                        $nombre_formulario = get_sub_field('nombre_formulario'); 
                        $link_formulario = get_sub_field('link_formulario');  
                         $icono_formulario = get_sub_field('icono_formulario');  
                        ?>
				...
				<?php endif;    endif;
                            ...
                            if( get_row_layout() == 'docenteshorarios' ):  
                      		...
                      		// check for rows (parent repeater)
				if( have_rows('anios_anteriores') ): ?>
					
					<?php 

					// loop through rows (parent repeater)
					while( have_rows('anios_anteriores') ): the_row();
		...
		?>
		 ...
		 <p>
             <a href="<?php echo $link_item_aa; ?>"><?php echo $nombre_item_aa; ?></a>
      </p>
                    <hr class="gris">
