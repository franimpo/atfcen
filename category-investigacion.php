    ...
    {        bcn_display();    }?>
                ...
                <div class="row">
                 ...
                 <div class="col-md-7" id="postslist">
                                  <?php  get_template_part( 'template-parts/part', 'ifnoposts' );  $catquery = new WP_Query( 'cat=10&posts_per_page=10' ); ?>
...
?>
         ...
         <div class="col-md-4 col-md-offset-1">
             <hr class="grisclaro">
             <h4>Menu Investigación</h4>
            <?php 
          /* Menu Seccion navigation */
wp_nav_menu( array(
  'theme_location' => 'investigacion',
